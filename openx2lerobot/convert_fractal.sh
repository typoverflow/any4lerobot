...
"$PYTHON" openx_rlds.py \
    --raw-dir /localscratch/cgao304/dev/datasets/rlds/fractal20220817_data/0.1.0 \
    --local-dir /localscratch/cgao304/dev/datasets/lerobot_v3/fractal/ \
    --use-videos \
    --num-proc 8 \
    --image-writer-process 1 \
    --image-writer-threads 4 \
    --prefetch-buffer 2 \
    --repo-id typoverflow/fractal \
    --push-to-hub
