...
def relative_pose(R_cur: tf.Tensor, p_cur: tf.Tensor, R_tgt: tf.Tensor, p_tgt: tf.Tensor):
...
def world_delta(R_cur: tf.Tensor, p_cur: tf.Tensor, R_tgt: tf.Tensor, p_tgt: tf.Tensor):
...
def change_delta_frame(R_delta: tf.Tensor, p_delta: tf.Tensor, R_src_to_dst: tf.Tensor):
